...
$cocktails = $query->getAll('cocktails');

require_once '../header.php'
?>

<div class="container w-50">
    <h1 class="display-1 text-center">List of Cocktails</h1>
    <div class="text-end">
    ...
    <table class="table table-striped table-hover mt-3 shadow">
        ...
        <?php foreach ($cocktails as $cocktail) : ?>
            <tr>
                ...
                <td><?= $cocktail['name'] ?></td>
                <td><?= $cocktail['price'] ?> TJS</td>
                <td class="text-center"><a href="./edit.php?id=<?= $cocktail['id'] ?>"
                                           class="btn btn-outline-info btn-sm" title="UPDATE"><i
                                class="bi bi-pencil-square"></i></a</td>
                <td class="text-center"><a href="./delete.php?id=<?= $cocktail['id'] ?>"
