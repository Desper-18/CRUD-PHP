...
$tableName = "dishes";
$meal = $query->getById($tableName, $id);
...
?>
    ...
    <div class="container w-50">
        <h1 class="display-1 text-center">Update Meal Info</h1>
        <?php if ($error_msg) : ?>
        ...
        <form method="post" class="bg-info p-5 rounded text-center">
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" name="name" value="<?= $meal[0]['name'] ?>">
            </div>
            <div class="input-group mb-3">
                <label class="input-group-text" id="basic-addon1">Price</label>
                <input type="number" class="form-control" name="price" value="<?= $meal[0]['price'] ?>">
            </div>
